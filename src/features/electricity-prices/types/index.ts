...
export const GRID_COMPANIES: GridCompany[] = [
  { name: 'Radius Elnet (DK2 – Greater Copenhagen)', gln: '5790000705689', area: 'DK2' },
  { name: 'Cerius (DK2 – North Zealand)',            gln: '5790000705184', area: 'DK2' },
  { name: 'N1 (DK1 – North/Mid Jutland)',            gln: '5790001089030', area: 'DK1' },
  { name: 'TREFOR El-net (DK1 – South Jutland)',     gln: '5790000392261', area: 'DK1' },
  { name: 'Konstant Net (DK1 – Mid Jutland)',        gln: '5790000375318', area: 'DK1' },
]
