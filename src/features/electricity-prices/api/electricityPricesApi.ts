...
import type { DayAheadPrice, DayAheadPricesQueryParams, DayAheadPricesResponse } from '../types'
...
export async function fetchElectricityPrices(
  ...
  url.searchParams.set('filter', JSON.stringify({ PriceArea: [params.priceArea] }))
